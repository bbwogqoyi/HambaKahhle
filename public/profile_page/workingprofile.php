    ...
    <div name ="User_details" class="px-6 border-black" >
      ...
      <br>
        ...
        <div name ="">
            ...
            <input type="text" name="firstname" id="fn" class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline" value="<?php echo $firstname;?>">
        </div>
        ...
        <div name ="">
            ...
            <input type="text" name="lastname" id="ln" class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline" value="<?php echo $lastname;?>">
        </div>
       ...
       <br>
        ...
        <div name ="">
            ...
            <input type="text" name="e_mail" id="em" class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline" value="<?php echo $email;?>">
         </div>
      ...
      <div name ="">
            ...
            <input type="text" name="contactnum" id="cn" class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline" value="<?php echo $contactnum;?>">
      </div>
        <br>

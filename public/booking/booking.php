...
<body class="bg-grey-100 h-screen font-sans" onload="moveUp()">
            ...
            <form action="booking.php" method="POST" >
                <div class="border-indigo-400 p-8 border-t-8 bg-white mb-6 rounded-lg shadow-lg font-medium text-2xl">
                    <div class="mb-4">
                        ...
                        <label for="service required" class="text-indigo-400">Initial collection point </label><br>
                        <select name="initialCollectionPoint" id="initialCollectionPoint">
                            <option value="Bloemfontien">Bloemfontien (FS)</option>
                            <option value="Cape town">Cape town (WC)</option>
                            <option value="Durban">Durban (KZN)</option>
                            <option value="East London">East London (EC)</option>
                            <option value="Johannesburg">Johannesburg (Gau)</option>
                            <option value="Pietermaritzburg">Pietermaritzburgn (KZN)</option>
                            <option value="Port Elizabeth">Port Elizabeth (EC)</option>
                            <option value="Pretoria">Pretoria (Gau)</option>
                            <option value="Soweto">Soweto (Gau)</option>
                            <option value="Soweto">Vereeniging (Gau)</option>
                        </select>
                    </div>

                    <div class="mb-4">
                        <label for="start" class="text-indigo-400">Start date:</label>
                    ...
                    <div class="mb-4"> 
                        <label for="start" class="texttext-indigo-400">End date:</label>
                        <div style="width: 10%;"></div>
                    ...
                    <div class="mb-4">
                        <label for="service required" class="text-indigo-400">Number of passengers </label><br>
                        <select name="numPassengers" id="numPassengers">
                        ...
                        <label  class="text-indigo-400">Would you like to add a trailer? </label><br>
                    ...
                    <div class="inline-flex">
                        <div class="flex items-center animate-pulse">
                            <button type="submit" name="submit" id="submit" value="submit" class="bg-indigo-400 hover:bg-teal text-white font-bold py-2 px-4 rounded">
                                Add Booking
                            </button>
                        </div>

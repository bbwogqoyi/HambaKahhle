...
<body class="antialiased bg-gray-200">
		...
		while($row = $result->fetch_assoc()){
				 if($i % 2 != 0){
						...
						if($row["statusID"] == 1){
							...
							echo " <td class=\"border px-4 py-4 bg-gray-300\"> In Progress</td>";
            ...
            <span class=\"inline-flex w-full justify-between px-3\">
              <a class=\"tooltipe\"  href=\"../daytripdashboard/daytripdashboard.php?id=" . $row['bookingID'] . "\">
  ...
  <span class=\"tooltiptextc\">Send confirmation of booking to admin</span>
</div>
</p> 
			   </svg>
              </a>

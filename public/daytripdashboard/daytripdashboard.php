  ...
  <div class="mt-16 py-8 px-6 mx-auto bg-white flex flex-wrap items-center w-full lg:w-4/5">
    ...
    <div class="flex justify-between w-full items-center mx-4 mb-10"> 
	  ...
	  <div class="w-1/3">
        <div class="relative">
            ...
            <button class="bg-indigo-300 hover:bg-indigo-500 text-white font-bold py-2 px-6 mr-2 rounded">
			<?php
            echo "  <a href=\"../daytripbooking/daytripbooking.php?id=" . $_REQUEST['id'] . "\"> Add day trip</a>";
			  ?>
            </button>
    ...
    <table class="table-auto text-left w-full">
      <thead class="bg-gray-200">
        <tr>
          <th class="w-1/6 px-4 py-2">Trip Date</th>
          <th class="w-1/6 px-4 py-2">tripTime</th>
	...
	$conn = mysqli_connect($servername, $username, $password, $database) or die("Could not connect to database!");
		...
		$query = "SELECT * FROM daytrip WHERE bookingID = " . $bookingID ;
		...
		while($row = $result->fetch_assoc()){
				...
				echo " <td class=\"border px-4 py-4 bg-blue-500\"> " . $row["pickLocation"] . "</td>";
				echo " <td class=\"border px-4 py-4 bg-blue-500\"> " . $row["dropLocation"] . "</td>";
				...
				echo " <td class=\"border px-4 py-4 \"> " . $row["pickLocation"] . "</td>";
				echo " <td class=\"border px-4 py-4\"> " . $row["dropLocation"] . "</td>";
			 }
			// echo "</tr>";

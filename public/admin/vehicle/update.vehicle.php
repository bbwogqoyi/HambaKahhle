...
$make = $model = $year = $numberOfSeats = $licence = $registration = $purchaseDate = null;
...
if( isset($_POST['addNewVehicle']) || isset($_POST['updateVehicle']) ) {
  ...
  $numberOfSeats = filter_var($_POST['numberOfSeats'], FILTER_SANITIZE_STRING);
  $licenseCode = filter_var($_POST['licenseCode'], FILTER_SANITIZE_STRING);
  $dateOfPurchase = filter_var($_POST['dateOfPurchase'], FILTER_SANITIZE_STRING);
}
...
function updateExistingVehicle($make, $model, $year, $numberOfSeats, $licenseCode, $dateOfPurchase, $registration) {
  $query = 
    "UPDATE vehicle v
      set
      v.make='$make', 
      v.model='$model', 
      v.year='$year', 
      v.numberOfSeats='$numberOfSeats',
      v.licenseCode='$licenseCode', 
      v.dateOfPurchase='$dateOfPurchase'
      where v.registrationNumber='$registration'"
    ;
...
if( isset($_POST['updateVehicle']) ) {
  $registration = filter_var($_REQUEST['registrationNumber'], FILTER_SANITIZE_STRING);
  $dbMutationStatus=
    updateExistingVehicle($make, $model, $year, $numberOfSeats, $licenseCode, $dateOfPurchase, $registration);

  $url = "./view.vehicle.php?registrationNumber=$registration";
  header("Location: ".$url);
}
?>
  ...
  <div class="mt-16 py-8 px-6 mx-auto bg-white flex flex-wrap items-center w-full lg:w-4/5">
    ...
    <form 
      ...
      <?php 
        ...
        echo 'action="./update.vehicle.php'. $queryParam .'"';
      ?>
    >
      ...
      <div class="flex flex-wrap -mx-3 mb-6">
        ...
        <div class="form-group w-full md:w-1/2 px-3 mb-6 md:mb-0">
          ...
          <input
          <?php echo ( 'value="'. $vehicle['dateOfPurchase'] .'"'  ); ?> 
            name="dateOfPurchase" id="dateOfPurchase" type="date" placeholder="YYYY-MM-DD" required
      ...
      <div class="flex flex-wrap -mx-3 mb-8">
        <div class="form-group w-full md:w-1/2 px-3 mb-6 md:mb-0">
          ...
          <input 
            <?php echo ( 'value="'. $vehicle['numberOfSeats'] .'"'  ); ?> 
        ...
        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          ...
          <div class="relative">
            <select 
              name="licenseCode" id="licenseCode"
      ...
      <div class="mt-16 mb-4 flex justify-end w-full items-center">
        <button 
          type="submit" id="updateVehicle" name="updateVehicle"

...
function updateExistingEmployee($employeeID, $firstName, $lastName, $email, $password, $roleCd, $pImg) {
  $query = 
    "UPDATE employee e
      set
...
if( isset($_POST['updateEmployee']) ) {
  $employeeID = filter_var($_REQUEST['employeeID'], FILTER_SANITIZE_STRING);
  $dbMutationStatus=
    updateExistingEmployee($employeeID, $firstName, $lastName, $email, $password, $roleCd, null);

  $url = "./view.employee.php?employeeID=$employeeID";
  header("Location: ".$url);
}
?>
  ...
  <div class="mt-16 py-8 px-6 mx-auto bg-white flex flex-wrap items-center w-full lg:w-4/5">
    ...
    <form 
      ...
      <?php 
        ...
        echo 'action="./update.employee.php'. $queryParam .'"';
      ?>
    >
        ...
        <div class="w-2/3 flex flex-col">
          ...
          <div class="flex w-full mb-8">
            <div class="form-group w-full md:w-1/2 px-3 mb-6 ">
              ...
              <input
                <?php echo ( 'value="'. $employee['firstName'] .'"'  ); ?>
            ...
            <div class="form-group w-full md:w-1/2 px-3 mb-6 ">
              ...
              <input
                <?php echo ( 'value="'. $employee['lastName'] .'"'  ); ?>
          ...
          <div class="flex w-full mb-8">
            ...
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              <div class="form-group relative">
                <select 
                  name="employeeTypeID" id="employeeTypeID" required
                  class="form-control block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 
      ...
      <div class="pr-4 mt-8 mb-4 w-full flex items-center justify-end">
        <button 
          type="submit" id="updateEmployee" name="updateEmployee"
  ...
  <script>
    window.onload = function () {
      ...
      pristine.addValidator(elem, function(value) {
        ...
        if (value.length && pwd.value.length && (value === pwd.value)){
            return true;
        }
        return false;

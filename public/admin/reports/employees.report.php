...
<body class="antialiased bg-gray-200">
  ...
  <div class="mt-16 mb-16 py-8 px-6 mx-auto bg-white items-center w-full lg:w-4/5">
    ...
    <div class="">
      <nav class="flex flex-col sm:flex-row">
        ...
        <a href="./depots.report.php" 
            class="text-gray-600 py-4 px-6 block hover:text-indigo-500 hover:font-semibold  focus:outline-none" >
            Depots
        </a>
        <a href="./employees.report.php"
    ...
    <table class="table-fixed text-left w-full mt-8">
      <caption class="text-lg font-medium mb-3">Drivers</caption>

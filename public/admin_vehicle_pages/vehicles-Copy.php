...
<body class="antialiased bg-gray-200">
  ...
  <div class="mt-16 py-8 px-6 mx-auto bg-white flex flex-wrap items-center w-full md:w-4/5 rounded">
    ...
    <table class="table-fixed w-full">
      ...
      <div class="tab_bar w-full">
      <ul class="flex border-b">
        <li class="-mb-px mr-1">
          <a class="bg-white inline-block border-l border-t border-r rounded-t py-2 px-4 text-black-600 font-semibold" href="#">All cars</a>
        </li>
        <li class="mr-1">
          <a class="bg-white inline-block py-2 px-4 text-black-600 hover:text-black-600 font-semibold" href="#">Active </a>
        </li>
        <li class="mr-1">
          <a class="bg-white inline-block py-2 px-4 text-black-600 hover:text-black-600 font-semibold" href="#">in Progress</a>
        </li>
      </ul>
    </div>
    ...
    <div class="flex justify-between w-full items-center mt-10  mb-10"> 
      <div class="w-1/3">
        <div class="relative">
      ...
      <button class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-10 rounded"><a href="add_vehicle.php">
        Add Car
      </button>
    </div>
      <thead>
